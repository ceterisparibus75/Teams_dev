// Prompts système, exemple-modèle, et schéma d'outil tool_use pour Claude.
// Modifier ces strings change directement le comportement de la génération
// PV — toute évolution doit être validée par tests + relecture.

import type Anthropic from '@anthropic-ai/sdk'
import type { MeetingAttendanceRecord } from '@/types'
import { extractTranscriptSpeakers } from './converters'
...
export { SYSTEM_PROMPT, GENERER_PV_TOOL }
